import { version as version$1, createVNode, mergeProps, toRef, toRefs, ref, computed, watchEffect, shallowRef, watch, nextTick, Transition, provide, onScopeDispose, reactive, withDirectives, resolveDirective, vShow, Fragment, inject as inject$1, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, unref, defineComponent as defineComponent$1, capitalize, camelize, h, toRaw, readonly, isRef, Text, resolveDynamicComponent, TransitionGroup, effectScope, warn, toHandlers, Teleport, cloneVNode, createTextVNode, useSSRContext, createApp, isReadonly, onErrorCaptured, onServerPrefetch, isShallow, isReactive, defineAsyncComponent, withCtx, toDisplayString, openBlock, createBlock, createCommentVNode, renderList } from 'vue';
...
function defineComponent(options2) {
  ...
  if (options2._setup) {
    options2.props = propsFactory(options2.props ?? {}, toKebabCase(options2.name))();
...
function createTheme(options2) {
  const parsedOptions = reactive(parseThemeOptions(options2));
...
const options = JSON.parse('{"ssr":true,"treeshaking":true}');
const templates_plugin_6610144c_juLMdYARAX = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  ...
  unhead_KgADcZ0jPj,
  router_CaKIoANnI2,
  templates_plugin_6610144c_juLMdYARAX
];
            ...
            _push2(ssrRenderComponent(VContainer, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(dynamicForm)) {
                    _push3(ssrRenderComponent(VCard, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="text-center my-5"${_scopeId3}><h1${_scopeId3}>Kuantaz</h1><p${_scopeId3}>Prueba Tecnica</p></div><!--[-->`);
                          ssrRenderList(unref(dynamicForm).form, (field) => {
                            _push4(ssrRenderComponent(VContainer, null, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div class="text-subtitle-1 text-medium-emphasis"${_scopeId4}>${ssrInterpolate(field.question)}</div>`);
                                  if (field.type == "INPUT") {
                                    _push5(`<div${_scopeId4}>`);
                                    _push5(ssrRenderComponent(VTextField, {
                                      density: "compact",
                                      variant: "outlined",
                                      modelValue: field.response,
                                      "onUpdate:modelValue": ($event) => field.response = $event
                                  ...
                                  if (field.type == "CHECKBOX") {
                                    ...
                                    _push5(ssrRenderComponent(VCheckbox, {
                                      modelValue: field.response,
                                      "onUpdate:modelValue": ($event) => field.response = $event,
                                      label: `${field.response ? field.items[0] : field.items[1]}`
                                    }, null, _parent5, _scopeId4));
                                    _push5(`</div>`);
                                  } else {
                                    _push5(`<!---->`);
                                  ...
                                  return [
                                    createVNode("div", { class: "text-subtitle-1 text-medium-emphasis" }, toDisplayString(field.question), 1),
                                    field.type == "INPUT" ? (openBlock(), createBlock("div", { key: 0 }, [
                                    ...
                                    field.type == "SELECT" ? (openBlock(), createBlock("div", { key: 1 }, [
                                      createVNode(VSelect, {
                                        label: "Seleccione una respuesta",
                                        items: field.items,
                                        "item-title": "value",
                                    ...
                                    field.type == "CHECKBOX" ? (openBlock(), createBlock("div", { key: 2 }, [
                          ...
                          return [
                            createVNode("div", { class: "text-center my-5" }, [
                              createVNode("h1", null, "Kuantaz"),
                              createVNode("p", null, "Prueba Tecnica")
                            ]),
                            (openBlock(true), createBlock(Fragment, null, renderList(unref(dynamicForm).form, (field) => {
                  ...
                  return [
                    unref(dynamicForm) ? (openBlock(), createBlock(VCard, {
                      key: 0,
                      class: "mx-auto pa-12 pb-8",
                      elevation: "8",
                      "max-width": "550",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCardSubtitle, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`A continuacion te mostramos tus respuestas:`);
                      } else {
                        return [
                          createTextVNode("A continuacion te mostramos tus respuestas:")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(VList, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                        ssrRenderList(unref(dynamicForm).form, (item) => {
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(VListItemTitle, null, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`${ssrInterpolate(item.question)}`);
                                    } else {
                                      return [
                                ...
                                if (item.type == "CHECKBOX") {
                                  _push5(ssrRenderComponent(VListItemSubtitle, null, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`${ssrInterpolate(item.response ? item.items[0] : item.items[1])}`);
                                      } else {
                                        return [
                                          createTextVNode(toDisplayString(item.response ? item.items[0] : item.items[1]), 1)
                                        ];
                                      }
                                    }),
                                    _: 2
                                  ...
                                  _push5(ssrRenderComponent(VListItemSubtitle, null, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`${ssrInterpolate(item.response.toString())}`);
                                      } else {
                                        return [
                                          createTextVNode(toDisplayString(item.response.toString()), 1)
                                        ];
                                      }
                                    }),
                                    _: 2
                                ...
                                return [
                                  ...
                                  item.type == "CHECKBOX" ? (openBlock(), createBlock(VListItemSubtitle, { key: 0 }, {
                                    default: withCtx(() => [
                                      createTextVNode(toDisplayString(item.response ? item.items[0] : item.items[1]), 1)
                                    ]),
                                    _: 2
                                  }, 1024)) : (openBlock(), createBlock(VListItemSubtitle, { key: 1 }, {
                                    default: withCtx(() => [
                                      createTextVNode(toDisplayString(item.response.toString()), 1)
                                    ]),
                                    _: 2
                        ...
                        return [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(dynamicForm).form, (item) => {
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dynamic-form.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_dynamic_form = __nuxt_component_0;
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(VContainer, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_dynamic_form, null, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_dynamic_form)
        ];
      }
    }),
    _: 1
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-3941c9f8.mjs').then((r) => r.default || r));
